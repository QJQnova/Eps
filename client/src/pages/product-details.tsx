        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
            {Number(product.price) > 0 ? (
              ...
              <>
                <Button 
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white w-full h-12 text-base font-medium shadow-md hover:shadow-lg transition-all duration-200 border-0"
                ...
                <Button 
                  variant="outline"
                  className="border-green-600 text-green-600 hover:bg-green-50 w-full h-12 text-base font-medium transition-all duration-200"
                  onClick={() => window.open('https://wa.me/+78001013835?text=Здравствуйте! Интересует товар: ' + encodeURIComponent(product.name), '_blank')}
                >
