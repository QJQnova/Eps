              ...
              <div className="bg-gradient-to-br from-red-900/80 to-amber-800/80 backdrop-blur-sm rounded-3xl p-6 lg:p-8 shadow-2xl border border-white/20 hover:shadow-3xl transition-all duration-500 max-w-md mx-auto">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center pulse-icon">
                  ...
                  <h2 className="text-xl font-bold text-white mb-2">Коллекция профессиональных инструментов</h2>
                  <p className="text-white/80 text-sm">ЭПС - надежный поставщик инструментов с 2005 года</p>
                </div>
