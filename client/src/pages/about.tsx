...
export default function AboutPage() {
  const locations = [
    {
      city: "Волгоград",
      address: "улица им Маршала Еременко, дом 44",
      phone: "+7 929 780-48-46",
      tollFree: "8 800 101 38 35"
    },
    {
      city: "Ростов-на-Дону",
      address: "проспект Королёва, 1Э",
      phone: "+7 960 444-75-95",
      tollFree: "8 800 101 38 35"
    },
    {
      city: "Санкт-Петербург",
      address: "проспект Железнодорожный 14 к7",
      phone: "+7 981 858-21-43",
      tollFree: "8 800 101 38 35"
    },
    {
      city: "Новороссийск",
      address: "село Гайдук улица Строительная дом 14",
      ...
      <div className="mb-10">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
          <div className="p-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Наша цель — обеспечить профессионалов надежным инструментом, который позволит выполнять работу максимально эффективно и качественно. Мы стремимся к долгосрочным партнерским отношениям с нашими клиентами, предоставляя им лучший сервис и техническую поддержку.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Компания «ЭПС» постоянно расширяет свое присутствие по всей стране, открывая новые филиалы и пункты выдачи заказов, чтобы быть ближе к своим клиентам.
            </p>
          </div>
        </div>
      </div>
