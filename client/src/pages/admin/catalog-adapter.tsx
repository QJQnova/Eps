...
Дрель электрическая BOSCH GSB 550,DRILL-BOSCH-550,0,Электроинструмент,"Профессиональная дрель с ударной функцией, мощность 550Вт, патрон 13мм, регулировка оборотов",data:image/svg+xml;base64,...
Молоток слесарный STANLEY 500г,HAMMER-STANLEY-500,0,Ручной инструмент,"Молоток слесарный с фибергласовой ручкой, вес 500г, антивибрационная система",data:image/svg+xml;base64,...
Пила циркулярная MAKITA HS7611,SAW-MAKITA-7611,0,Электроинструмент,"Циркулярная пила 1600Вт, диск 190мм, глубина пропила 68мм, лазерная направляющая",data:image/svg+xml;base64,...`;
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    ИИ извлечет названия, категории и описания товаров, автоматически создаст изображения-заглушки.
                  </CardDescription>
                </CardHeader>
