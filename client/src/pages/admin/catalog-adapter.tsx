...
Дрель электрическая,DRILL-001,2500,Электроинструмент,Профессиональная дрель 800W,
Молоток слесарный,HAMMER-001,450,Ручной инструмент,Молоток 500г с фибергласовой ручкой,
Пила циркулярная,SAW-001,8900,Электроинструмент,Циркулярная пила 1200W,`;
            ...
            <TabsContent value="upload" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Загрузите файл каталога поставщика в любом формате (XLSX, CSV, XML). 
                    Claude AI автоматически проанализирует структуру и адаптирует данные в нужный формат.
                  </CardDescription>
                </CardHeader>
